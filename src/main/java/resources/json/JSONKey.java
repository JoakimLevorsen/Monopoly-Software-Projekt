...
*/
public enum JSONKey {
    TEST("test"), START_PAYMENT("startPayment"), CURRENTLY_BROKE("currentlyBroke"), PLAYER_BROKE_TITLE("playerBrokeTitle"), SELL_PROPERTY("sellProperty"), MORTGAGE_PROPERTY("mortgageProperty"), YOU_HAVE_CHOSEN("youHaveChosen"), WHAT_DO("whatDo"), HOUSES_ON_PROPERTY("housesOnProperty"), SPACES("spaces"), NAME("name"), TYPE("type"), PRICE("price"),
